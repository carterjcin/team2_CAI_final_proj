"""
pages/overview.py — Overview page (registered at "/overview")
...
layout = dbc.Container(
    [
        ...
        dbc.Row(id="ov-kpi-row", className="mb-3 g-3"),
        dcc.Graph(id="ov-choropleth", style={"height": "65vh"}),
    ],
    fluid=True,
)
...
@callback(
    ...
    Input("ov-year-range", "value"),
    Input("ov-carrier-dropdown", "value"),
)
def update_map(year_range, carrier):
    ...
    if filtered.empty:
        ...
        return transparent_bg(empty_fig)
